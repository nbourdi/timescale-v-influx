...
base_path="../../data/timescale/queries/devops_h10"
...
for query_type in "${under_10h_queries[@]}"; do
    ...
    tsbs_generate_queries --use-case="devops" --seed=0 --scale=50 \
        ...
        --queries=50 --format="timescaledb" --query-type="$query_type" \
...
base_path="../../data/timescale/queries/devops_d4"
...
base_path="../../data/timescale/queries/devops_d16"
